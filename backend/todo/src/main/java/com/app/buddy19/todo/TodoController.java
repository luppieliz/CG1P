...
public class TodoController {
    ...
    /**
     * This method is used to validate whether a user is authenticated
     */
    ...
    @ApiOperation(value = "View a list of todos generated by a specific user", response = List.class)
    ...
    @ApiOperation(value = "View a list of todos assigned to a specific user", response = List.class)
    ...
    @ApiOperation(value = "View a specific todo of a specific user based on its id", response = Todo.class)
    ...
    @ApiOperation(value = "Create a new todo by a specific user", response = ResponseEntity.class)
    ...
    @ApiOperation(value = "Update a specific todo of a specific user based on its id", response = ResponseEntity.class)
    ...
    @ApiOperation(value = "Delete a specific todo of a specific user based on its id", response = ResponseEntity.class)
