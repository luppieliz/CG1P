...
public class TodoController {
    ...
    public List<Todo> getCreatedTodos(@AuthenticationPrincipal User authenticatedUser, @PathVariable Long userId) {
    ...
    public List<Todo> getAssignedTodos(@AuthenticationPrincipal User authenticatedUser, @PathVariable Long userId) {
        validateUser(authenticatedUser.getId(), userId);
